...
class FAdaptiveScope extends InheritedWidget {
  ...
  static FPlatformVariant of(BuildContext context) =>
      context.dependOnInheritedWidgetOfExactType<FAdaptiveScope>()?.platform ??
      _platform;
  ...
  static FPlatformVariant get _platform {
    ...
    return switch (defaultTargetPlatform) {
      ...
      .macOS => .macOS,
      .linux => .linux,
      _ => defaultTargetPlatform.name == 'ohos' ? .android : .fuchsia,
    };
  }
  ...
  FAdaptiveScope({required super.child, FPlatformVariant? platform, super.key})
