...
class FModalBarrier extends StatelessWidget {
  ...
  static void defaultCutoutBuilder(Path path, Rect bounds) =>
      path.addRect(bounds);
...
class _CutoutClipper extends SingleChildRenderObjectWidget {
  ...
  const _CutoutClipper({
    ...
    required this.cutoutBuilder,
    super.child,
  });

  @override
  RenderObject createRenderObject(BuildContext _) =>
      _RenderCutoutClipper(cutout: cutout, cutoutBuilder: cutoutBuilder);

  @override
  void updateRenderObject(BuildContext _, _RenderCutoutClipper renderObject) =>
      renderObject
        ..cutout = cutout
        ..cutoutBuilder = cutoutBuilder;
...
class _RenderCutoutClipper extends RenderProxyBox {
  ...
  _RenderCutoutClipper({
    required RenderBox cutout,
    required void Function(Path path, Rect bounds) cutoutBuilder,
  }) : _cutout = cutout,
...
class _SemanticsClipper extends SingleChildRenderObjectWidget {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties.add(
      DiagnosticsProperty('clipDetailsNotifier', clipDetailsNotifier),
    );
  }
}
...
class _AnyTapGestureRecognizer extends BaseTapGestureRecognizer {
  ...
  bool isPointerAllowed(PointerDownEvent event) =>
      onAnyTapUp != null && super.isPointerAllowed(event);
